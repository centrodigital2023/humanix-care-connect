  ...
  itemListElement: [
    ...
    // en webApplicationLd en lugar de Product con Offer.
    {
      ...
      item: {
        ...
        description: "Para familias y profesionales que quieren todo activo. Verificación RETHUS, mapa en vivo y contacto ilimitado.",
    ...
    },
    {
      ...
      item: {
        ...
        description: "Para profesionales que quieren visibilidad máxima, coach IA de carrera y boost en búsquedas.",
    ...
    },
    {
      ...
      item: {
        ...
        description: "Para clínicas, hospitales y agencias de cuidado. Multi-usuario, pipeline con scoring IA y onboarding asistido.",
