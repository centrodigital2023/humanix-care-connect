    ...
    <>
      ...
      >
        <LegalSection title="1. Autorización">
          <p>
            Al marcar la casilla de aceptación o continuar usando Humanix, autorizas de manera
            previa, expresa, libre e informada a <strong>Humanix Colombia S.A.S.</strong> para
            recolectar, almacenar, usar, circular, suprimir, procesar y transmitir tus datos
            personales con las finalidades aquí descritas.
          </p>
        </LegalSection>
        <LegalSection title="2. Finalidades específicas">
          <p>
            ...
            RETHUS, Registraduría); (c) facilitar la conexión profesional/familia; (d) procesar
            pagos y facturación electrónica DIAN; (e) enviar notificaciones operativas y comerciales
            (con opción de retiro); (f) realizar análisis estadístico y mejora del servicio; (g)
            prevenir fraude mediante modelos de IA auditables.
          </p>
        </LegalSection>
        <LegalSection title="3. Datos sensibles y de menores">
          <p>
            ...
            facultativo y autorizo su tratamiento únicamente para las finalidades de prestación
            segura del servicio.
          </p>
        </LegalSection>
        <LegalSection title="4. Tus derechos">
          <p>
            ...
            error; (iii) <strong>solicitar prueba</strong> de la autorización; (iv) ser informado
            del uso; (v) presentar quejas ante la <strong>SIC</strong>; (vi) revocar la autorización
            y/o solicitar la supresión cuando no exista deber legal de conservar.
          </p>
        </LegalSection>
