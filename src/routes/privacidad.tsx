    ...
    <>
      ...
      >
        ...
        <LegalSection title="2. Datos que recolectamos">
          <p>
            Datos de identificación (nombre, cédula), contacto (correo, teléfono), datos
            profesionales (RETHUS, especialidad, certificaciones), geolocalización durante servicios
            activos, datos de pago tokenizados y métricas de uso de la plataforma.
          </p>
        </LegalSection>
        ...
        <LegalSection title="7. Conservación">
          <p>
            Conservamos los datos mientras exista una relación contractual y por los términos
            legales posteriores (obligaciones tributarias, contables y de salud pública).
          </p>
        </LegalSection>
