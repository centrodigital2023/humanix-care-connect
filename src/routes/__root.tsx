...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conectamos talento en salud con el mejor empleo. Encuentra enfermeros y cuidadores verificados con pago directo y geolocalización en Colombia." },
      { property: "og:description", content: "Conectamos talento en salud con el mejor empleo. Encuentra enfermeros y cuidadores verificados con pago directo y geolocalización en Colombia." },
      { name: "twitter:description", content: "Conectamos talento en salud con el mejor empleo. Encuentra enfermeros y cuidadores verificados con pago directo y geolocalización en Colombia." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/13c8963b-e53e-4476-b9e5-92e660667412" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/13c8963b-e53e-4476-b9e5-92e660667412" },
    ],
    links: [
