...
-- Professionals: remove available=true AND published=true filters (only keep blocked=false)
-- Families: remove visible_on_map=true filter (keep coordinates requirement)
-- Institutions: remove visible_on_map=true filter (keep coordinates requirement)
...
-- ─── FAMILY PROFILES ─────────────────────────────────────────────────────────
-- Show all families that have coordinates (respect privacy: no coords = opted out)
...
-- Show all institutions that have coordinates
